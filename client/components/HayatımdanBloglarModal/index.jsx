...
const HayatimdanBloglarModal = ({selectedBlogID, setselectedBlogID}) => {
    ...
    useEffect(() => {
        ...
        if (selectedBlogID && HayatimdanBloglarOpen) {
    ...
    useEffect(() => {
        ...
        if (!HayatimdanBloglarOpen) {
            handleCancel();
        }
    }, [HayatimdanBloglarOpen]);
    ...
    const handleInputChange = (e) => {
        ...
        setcreateBlogEtiketler(e.target.value);
    };
    ...
    return (
        <div>
            <Modal forceRender className="HayatimdanBloglarModal flex !w-full lg:!w-[1000px] flex-col justify-start items-center bg-white h-fit p-0" title={null} closable={false} open={HayatimdanBloglarOpen} maskClosable={false} footer={null} centered={true} onCancel={handleCancel}>
                <div className='w-[45px] h-[45px] absolute  mt-0 right-0 flex flex-col justify-center items-center bg-[#B4F5FA] cursor-pointer text-[25px]' onClick={handleCancel}>X</div>

                <div className='hayatimdan-bloglar-modal-header !w-full h-[72px] flex flex-row justify-between items-center bg-[#02B1FF] p-2'>
                    <div className='w-full h-fit flex flex-row justify-start items-center gap-2'>
                        <svg id="vuesax-linear-blogger" xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 46.489 46.489">
                        ...
                        <span className='text-[24px] text-white font-Inter-Medium'>Hayatımdan Bloglar</span>
                    </div>
                    ...
                    >
                        <div className='content-top w-full flex flex-col md:flex-row gap-8'>
                            <div className='content-left w-full'>
                                ...
                                >
                                    <Input  className='h-[30px] rounded-none border-gray-300 shadow-sm'
                                        onChange={(e) => setcreateBlogSlug(e.target.value)} />
                                </Form.Item>
                                ...
                                >
                                    <Input  className='h-[30px] rounded-none border-gray-300 shadow-sm'
                                        onChange={(e) => setcreateBlogBaslik(e.target.value)} />
                                </Form.Item>
                                ...
                                >
                                    <Input className='h-[30px] rounded-none border-gray-300 shadow-sm'
                                        onChange={(e) => setcreateBlogMetaAciklama(e.target.value)} />
                                </Form.Item>
                                ...
                                >
                                    <Input className='h-[30px] rounded-none border-gray-300 shadow-sm'
                                        onChange={(e) => setcreateBlogOneCikanGorselLinki(e.target.value)} />
                                </Form.Item>
                                <Form.Item
                                    className='etiketler'
                                    label="Etiketler"
                            ...
                            <div className='content-right w-full'>
                                ...
                                >
                                    <Input.TextArea className=' rounded-none border-gray-300 shadow-sm' rows={18}
                                        onChange={(e) => setcreateBlogIcerik(e.target.value)} />
                                </Form.Item>
...
export default HayatimdanBloglarModal;