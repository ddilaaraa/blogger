...
const TeknikBloglarModal = ({selectedBlogID, setselectedBlogID}) => {
...
////////////
    ...
    useEffect(() => {
        ...
        if (selectedBlogID && TeknikBloglarOpen) {
    ...
    return (
        <div>
            <Modal forceRender className="HayatimdanBloglarModal flex !w-full lg:!w-[1000px] flex-col justify-start items-center bg-white h-fit p-0" title={null} closable={false} open={TeknikBloglarOpen} maskClosable={false} footer={null} centered={true} onCancel={handleCancel}>
                <div className='w-[45px] h-[45px] absolute  mt-0 right-0 flex flex-col justify-center items-center bg-[#F1D6FF] cursor-pointer text-[25px]' onClick={handleCancel}>X</div>

                <div className='hayatimdan-bloglar-modal-header !w-full h-[72px] flex flex-row justify-between items-center bg-[#BD3CFF] p-2'>
                    <div className='w-full h-fit flex flex-row justify-start items-center gap-2'>
                        ...
                        <span className='text-[24px] text-white font-Inter-Medium'>Blog</span>
                    </div>
...
export default TeknikBloglarModal;